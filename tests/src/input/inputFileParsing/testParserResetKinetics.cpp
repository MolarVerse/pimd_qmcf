...
TEST_F(TestInputFileReader, testParseNResetAngular)
{
    ...
    EXPECT_THROW_MSG(
        parser.parseNResetAngular(lineElements, 0), customException::InputFileException, "Nreset_angular must be positive");
}
...
TEST_F(TestInputFileReader, testParseFResetAngular)
{
    ...
    EXPECT_THROW_MSG(
        parser.parseFResetAngular(lineElements, 0), customException::InputFileException, "Freset_angular must be positive");
}
